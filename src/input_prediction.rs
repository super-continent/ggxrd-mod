...
pub unsafe fn handle_simulation_step() {
    ...
    let data_point = DataPoint {
        ...
        player_1_sprite: crate::helpers::process_string(&player_1.current_sprite()),
        ...
        player_2_sprite: crate::helpers::process_string(&player_2.current_sprite()),
